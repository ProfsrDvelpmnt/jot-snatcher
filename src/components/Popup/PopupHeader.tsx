      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex flex-col items-center gap-1 flex-shrink-0 ml-4 max-w-[60px]">
          <button
            ...
            className="w-[24px] h-[18px] rounded bg-white/20 hover:bg-white/30 text-white flex items-center justify-center text-xs font-bold transition-all duration-200 hover:scale-110"
            title="Close"
          >
            ×
          </button>
          <select 
            ...
            className="bg-muted-purple border border-accent text-white px-1 py-0.5 rounded text-[9px] font-semibold cursor-pointer transition-all hover:bg-accent hover:border-rose-gold min-w-[24px] h-[18px]"
          >
